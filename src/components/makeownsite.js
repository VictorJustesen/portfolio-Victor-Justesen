...
export default function Makeownsite(){
   ...
   <div>
        <div style={{fontSize:25}}>
            ...
            <h3>Jeg er bosat i lyngby, vil gerne finde noget indenfor 20km, længere kan jeg ikke cykle </h3>
            <h3>Mine kompetancer ligger mest op af web dev, men jeg kan lidt af hvert og jeg lærer hurtigt!</h3>
            <h3>Så bare skriv hvis i mangler nogen, så skal jeg nok kigge på det!</h3>   
        </div>
